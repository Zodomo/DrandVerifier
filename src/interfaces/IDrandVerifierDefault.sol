...
/// @notice Interface for drand default-network (pedersen-bls-chained) BLS12-381 verification.
/// @dev Implemented by DrandVerifierDefault.
interface IDrandVerifierDefault {
    ...
    function verify(uint64 round, bytes calldata previousSignature, bytes calldata signature) external view returns (bool);
}
